      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2">
        ...
        <div className="relative order-1 mx-auto w-full max-w-lg md:order-none">
          ...
          <div className="relative aspect-square overflow-hidden rounded-[2.5rem] bg-white shadow-2xl ring-1 ring-white tilt-hover">
            <img src={mainImg.url} alt="Kids Finger Painting Kit with 12 colors and 30 activity cards" className="size-full object-contain p-4" />
          </div>
          ...
          <div className="absolute -bottom-6 -right-4 flex items-center gap-3 rounded-2xl bg-white p-3 shadow-xl ring-1 ring-border floaty" style={{ animationDelay: "-2s" }}>
            <div className="grid size-11 place-items-center rounded-xl bg-[#f39c12]/20 text-2xl">🖐️</div>
            <div>
