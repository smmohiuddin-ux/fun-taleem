      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div className="relative" data-reveal>
            ...
            <div className="relative aspect-square overflow-hidden rounded-3xl bg-white shadow-xl ring-1 ring-border tilt-hover">
          ...
          <div className="grid grid-cols-2 gap-4">
            {items.map((it, i) => (
              ...
              >
                <div className="mx-auto grid size-14 place-items-center rounded-3xl bg-[#26c6da]/15 text-[#0a2647] transition group-hover:scale-110 group-hover:rotate-6">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_1fr]">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {cats.map((c, i) => (
              ...
              >
                <div className={`grid size-12 shrink-0 place-items-center rounded-3xl ${c.color} transition group-hover:scale-110 group-hover:rotate-6`}>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            {steps.map((s, i) => (
              ...
              >
                <div className="grid size-14 shrink-0 place-items-center rounded-3xl bg-gradient-to-br from-[#0a2647] to-[#1e88e5] font-display text-2xl font-black text-white shadow transition group-hover:scale-110 group-hover:rotate-3">
